...
class _KayitFormuState extends State<KayitFormu> {
  ...
  void formuTestEt(String kullaniciAdi, String email, String parola) async{
    ...
    if (kayitDurumu)
      yetkiSonucu = await yetki.signInWithEmailAndPassword(email: email, password: parola);
    else{
      yetkiSonucu = await yetki.createUserWithEmailAndPassword(email: email, password: parola);
